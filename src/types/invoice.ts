...
// compute it from totalRecords/pageSize (see InvoicesTable's index.tsx).
...
// Only CREATED_DATE and TOTAL_AMOUNT are confirmed against the real API
// (CREATED_DATE from the sample URL this app was built from; TOTAL_AMOUNT
// by testing the "Amount" column sort in the UI) — the rest are unverified
// guesses at the naming convention.
